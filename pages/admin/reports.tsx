    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.labels && data.datasets) {
          const transformedData: ChartDataPoint[] = data.labels.map(
            (label: string, index: number) => {
              const incomeDataset = data.datasets.find(
                (d: any) => d.label === 'Ingresos'
              );
              const expenseDataset = data.datasets.find(
                (d: any) => d.label === 'Egresos'
              );
              const balanceDataset = data.datasets.find(
                (d: any) => d.label === 'Balance'
              );
      ...
      <div className='container mx-auto py-6 space-y-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            <Card className='bg-green-50 border-green-200 dark:bg-green-950 dark:border-green-800'>
              ...
              <CardContent>
                ...
                <Badge
                  variant='secondary'
                  className='bg-green-200 text-green-800 dark:bg-green-800 dark:text-green-200 mt-2'
                >
                  INGRESOS
                </Badge>
              </CardContent>
            ...
            <Card className='bg-red-50 border-red-200 dark:bg-red-950 dark:border-red-800'>
              ...
              <CardContent>
                ...
                <Badge
                  variant='secondary'
                  className='bg-red-200 text-red-800 dark:bg-red-800 dark:text-red-200 mt-2'
                >
                  EGRESOS
                </Badge>
              </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tendencia de ingresos, egresos y balance acumulado en el período
              seleccionado
            </CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <div className='h-80 flex flex-col items-center justify-center border-2 border-dashed rounded-lg'>
                ...
                <Button onClick={fetchReportData}>Intentar de nuevo</Button>
              </div>
            )}
          </CardContent>
        </Card>
